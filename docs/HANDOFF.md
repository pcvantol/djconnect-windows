...
DJConnect desktop `3.2.5` has been scaffolded as a .NET MAUI app targeting
...
- GitHub Actions CI and public unsigned Windows publication passed for
  `v3.1.9`. The `3.2.5` localization and deeplink activation release still needs CI/release validation after push.
